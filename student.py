...
class Student:
    ...
    def append_file():
        """
        This function includes the data in a file.
        """
        append_in_student_file()
        
    def all_students_info():
        """
        Simply used to display the contents required for teachers.
        """
    ...
    def pass_and_fail_students():
        """
        This function tells wether the student is pass or fail returns boolean value.
        """
        pm=0
        value=view_contents_of_student_file()
        for loop in value:
